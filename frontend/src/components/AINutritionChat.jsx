...
export default function AINutritionChat() {
  const [messages, setMessages] = useState([
    { role: 'ai', content: 'Hello! Based on your profile, I can give you personalized nutrition advice. What would you like to know?' }
  ]);
  ...
  const handleSend = async (e) => {
    ...
    try {
      ...
      if (result.success) {
        ...
        setMessages(prev => [...prev, { role: 'ai', content: result.error || "Missing profile info." }]);
      }
    } catch (err) {
