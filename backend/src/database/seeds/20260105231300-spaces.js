...
const spaces = [
  {
    ...
    hourly_rate: 20.00,
    is_active: true,
    amenities: JSON.stringify(['mirror_wall', 'sound_system', 'ac', 'essential_oils']),
  ...
  },
  {
    ...
    type: 'open_area',
    capacity: 20,
    equipment: JSON.stringify(['dumbbells_5-50lb', 'barbells', 'bench_press', 'squat_rack']),
    hourly_rate: 12.50,
    is_active: true,
  ...
  },
  {
    ...
    type: 'boxing_ring',
    capacity: 5,
    equipment: JSON.stringify(['boxing_ring', 'punching_bags', 'gloves', 'focus_mitts']),
    hourly_rate: 25.00,
    is_active: true,
  ...
  },
  {
    ...
    type: 'cardio_zone',
    capacity: 12,
    equipment: JSON.stringify(['treadmills', 'ellipticals', 'stationary_bikes', 'rowers']),
    hourly_rate: 10.00,
    is_active: true,
    amenities: JSON.stringify(['tv_screens', 'ac', 'ventilation']),
    description: 'Cardio area with panoramic views and individual entertainment systems',
  },
  {
    name: 'Private Room B',
    type: 'private_room',
    capacity: 4,
    equipment: JSON.stringify(['adjustable_bench', 'dumbbell_set', 'resistance_bands']),
    hourly_rate: 30.00,
    is_active: true,
    amenities: JSON.stringify(['mirror_wall', 'ac', 'privacy_curtain', 'sound_system']),
  ...
  },
  {
    ...
    description: 'High-energy spin studio with immersive lighting (Temporarily closed)',
  },
  {
    name: 'CrossFit Box',
    type: 'open_area',
    capacity: 30,
    equipment: JSON.stringify(['kettlebells', 'battle_ropes', 'pull_up_bars', 'medicine_balls']),
    hourly_rate: 22.00,
    is_active: true,
    amenities: JSON.stringify(['sound_system', 'ac', 'chalk_bowls', 'whiteboard']),
  ...
  },
  {
    ...
    type: 'private_room',
    capacity: 6,
    equipment: JSON.stringify(['sauna_bench', 'temperature_control', 'aromatherapy']),
    hourly_rate: 15.00,
    is_active: true,
